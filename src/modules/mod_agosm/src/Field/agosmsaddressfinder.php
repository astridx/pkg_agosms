...
namespace AG\Module\Agosms\Site\Field;
...
class AgosmsaddressfinderField extends TextField
{
	 ...
	 *                                      For example if the field has name="agosm" and the group value is set to "bar" then the
	 *                                      full field name would end up being "bar[agosm]".
	 *
	...
	protected function getLayoutPaths()
	{
		...
		return array(
			...
			JPATH_SITE . '/modules/mod_agosm/layouts',
			JPATH_SITE . '/layouts'
		);
	}
