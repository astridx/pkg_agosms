...
return};
var w=a.getAttribute('data-uriroot'),u=a.getAttribute('data-maptype'),p=a.getAttribute('data-lat'),s=a.getAttribute('data-lon'),i=a.getAttribute('data-scrollwheelzoom'),P=a.getAttribute('data-owngooglegesturetext'),D=a.getAttribute('data-googekey'),I=Joomla.JText._('PLG_AGOSMSADDRESSMARKER_TOUCH'),x=Joomla.JText._('PLG_AGOSMSADDRESSMARKER_SCROLL'),O=Joomla.JText._('PLG_AGOSMSADDRESSMARKER_SCROLLMAC'),W=a.getAttribute('data-specialicon'),d=a.getAttribute('data-popup'),m=a.getAttribute('data-showroutingcontrol');
if(m==='1'){var K=a.getAttribute('data-routingprofile'),v=a.getAttribute('data-routinglanguage'),M=a.getAttribute('data-routingmetric'),f=a.getAttribute('data-routewhiledragging'),S=a.getAttribute('data-routing_position'),G=a.getAttribute('data-routing_router'),y=a.getAttribute('data-fitSelectedRoutes'),h=(a.getAttribute('data-reverseWaypoints')==='true'),A=a.getAttribute('data-collapsible'),b=a.getAttribute('data-showAlternatives')};
...
if(!n.children.length>0){if(i==='0'){window['map'+t]=new L.Map('map'+t,{scrollWheelZoom:!1})}
else if(i==='2'){if(P==='1'){window['map'+t]=new L.Map('map'+t,{gestureHandling:!0,gestureHandlingText:{touch:I,scroll:x,scrollMac:O}})}
