...
L.MarkerCluster.include({_2PI:Math.PI*2,_circleAgosmtSeparation:25,_circleStartAngle:0,_spiralAgosmtSeparation:28,_spiralLengthStart:11,_spiralLengthFactor:5,_circleSpiralSwitchover:9,spiderfy:function(){if(this._group._spiderfied===this||this._group._inZoomAnimation){return};
...
this._group._spiderfied=null},_generatePointsCircle:function(e,t){var o=this._group.options.spiderfyDistanceMultiplier*this._circleAgosmtSeparation*(2+e),n=o/this._2PI,a=this._2PI/e,r=[],i,s;
n=Math.max(n,35);
r.length=e;
for(i=0;i<e;i++){s=this._circleStartAngle+i*a;
r[i]=new L.Point(t.x+n*Math.cos(s),t.y+n*Math.sin(s))._round()};
return r},_generatePointsSpiral:function(e,t){var s=this._group.options.spiderfyDistanceMultiplier,n=s*this._spiralLengthStart,a=s*this._spiralAgosmtSeparation,h=s*this._spiralLengthFactor*this._2PI,r=0,o=[],i;
o.length=e;
