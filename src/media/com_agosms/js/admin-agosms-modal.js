...
(function () {
  ...
  /**
    ...
    * View element calls jSelectAgosm when a agosm is clicked
    * jSelectAgosm creates the link tag, sends it to the editor,
    * and closes the select frame.
    */

  window.jSelectAgosm = function (id, title, catid, object, link, lang) {
    var hreflang = '';

    if (!Joomla.getOptions('xtd-agosms')) {
      // Something went wrong
      window.parent.Joomla.Modal.getCurrent().close();
      return false;
    }

    var _Joomla$getOptions = Joomla.getOptions('xtd-agosms'),
