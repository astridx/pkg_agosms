...
namespace Joomla\Component\Agosms\Site\Helper;
...
use Joomla\Component\Agosms\Site\Helper\Route as AgosmsHelperRoute;
	...
	public static function getAssociations($id = 0, $view = null)
	{
		...
		if ($view === 'agosms')
		{
			if ($id)
			{
				...
				{
					$return[$tag] = AgosmsHelperRoute::getAgosmsRoute($item->id, (int) $item->catid, $item->language);
				}
