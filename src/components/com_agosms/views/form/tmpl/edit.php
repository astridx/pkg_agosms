...
<script type="text/javascript">
	...
	{
		if (task == 'agosm.cancel' || document.formvalidator.isValid(document.getElementById('adminForm')))
		{
...
<div class="edit<?php echo $this->pageclass_sfx; ?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_agosms&view=form&w_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
		...
		<?php if ($this->user->authorise('core.edit.state', 'com_agosms.agosm')) : ?>
		...
		<div class="btn-toolbar">
			...
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('agosm.cancel')">
