		...
		if ($allowSelect)
		{
			$html .= JHtml::_(
				...
				array(
					...
					'bodyHeight'  => '70',
					'modalWidth'  => '80',
					'agosmter'      => '<a role="button" class="btn" data-dismiss="modal" aria-hidden="true">' . JText::_('JLIB_HTML_BEHAVIOR_CLOSE') . '</a>',
				)
			);
		}
		...
		if ($allowNew)
		{
			$html .= JHtml::_(
				...
				array(
					...
					'bodyHeight'  => '70',
					'modalWidth'  => '80',
					'agosmter'      => '<a role="button" class="btn" aria-hidden="true"'
