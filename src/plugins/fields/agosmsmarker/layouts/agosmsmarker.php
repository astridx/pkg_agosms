...
$script = "window.onload = function () {"
	...
	. ""
	. "var lat = document.getElementById('agosmsmarkerlat');"
	. "lat.value = hf[0];"
	...
	. "var iconcolor = document.getElementById('agosmsmarkericoncolor');"
	. "setSelectedIndex(iconcolor,hf[3]);"
	. "var icon = document.getElementById('agosmsmarkericon');"
...
<br>
<?php echo JText::_('Iconcolor'); ?>	
<select 
	id="agosmsmarkericoncolor">
	<option></option>
	<option value="red">red</option>
	<option value="darkred">darkred</option>
	<option value="orange">orange</option>
