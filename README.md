...
## What if the Google Map is not shown
Perhaps your key is not valid? In this case you see the Error 
"Google Maps JavaScript API error: InvalidKeyMapError" in the web console. 

If the restrictions of your key to restricte, you see the message 
