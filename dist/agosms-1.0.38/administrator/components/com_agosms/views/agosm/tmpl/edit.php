...
<form action="<?php echo JRoute::_('index.php?option=com_agosms&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="agosm-form" class="form-validate">
