...
var r=t.getElementsByTagName('button')[0],R=r.getAttribute('data-fieldsnamearray').split(','),v=r.getAttribute('data-geocoder'),E=r.getAttribute('data-googlekey'),S=r.getAttribute('data-mapboxkey');
r.onclick=function(){var e=[];[].forEach.call(R,function(t){var a=document.getElementById(t);
e.push(a.value)});
e=e.join();
