 ...
 * @since  4.0.0
 */
class FormcustomModel extends \AgosmNamespace\Component\Agosms\Administrator\Model\AgosmModel
{
	/**
	 ...
	 * @since  4.0.0
	 */
	public $typeAlias = 'com_agosms.agosmcustom';
