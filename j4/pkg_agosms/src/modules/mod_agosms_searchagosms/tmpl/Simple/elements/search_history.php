...
if ($history) {
	...
	echo "
			...
			<a href='#' id='search-history-clear{$module->id}' class='search-history-clear'>".JText::_('MOD_AGOSMSSEARCHAGOSMSBUTTON_HISTORY_CLEAR')."</a>
		</div>";
}
$doc = JFactory::getDocument();
$document->addScript(JURI::root(true) . '/media/mod_agosms_searchagosms/history/js.cookie.min.js');
?>
<script>
