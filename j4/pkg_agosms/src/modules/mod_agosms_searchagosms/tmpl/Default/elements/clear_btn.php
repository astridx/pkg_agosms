...
?>
		...
		<input type="button" value="<?php echo JText::_('MOD_AGOSMSSEARCHAGOSMSBUTTON_CLEAR'); ?>" class="btn btn-warning button reset " onClick="clearSearch_<?php echo $module->id; ?>()" />