...
$document->addStyleSheet(JURI::root(true) . '/media/mod_agosms_searchagosms/slider/bootstrap-slider.min.css');
$document->addScript(JURI::root(true) . '/media/mod_agosms_searchagosms/slider/bootstrap-slider.min.js');
$document->addScript(JURI::root(true) . '/media/mod_agosms_searchagosms/slider/agosmsaddressmarkerslider/agosmsaddressmarkerslider.js');
?>
<hr>
<div class="gsearch-field-slider custom-field">	
	...
	<h4>
		<?php echo JText::_("MOD_AGOSMSSEARCHAGOSMS_DISTANCE"); ?>
	</h4>
...
<div class="agosmsaddressmarkersurroundingdiv form-horizontal">
	<h4>
		<?php echo JText::_("MOD_AGOSMSSEARCHAGOSMS_CORDS"); ?>
	</h4>
<div class="control-group">
<label class="control-label"><?php echo JText::_('MOD_AGOSMSSEARCHAGOSMS_LAT'); ?></label>	
<div class="controls">
	<input 
		type="text"
...
<div class="control-group">
<label class="control-label"><?php echo JText::_('MOD_AGOSMSSEARCHAGOSMS_LON'); ?></label>	
<div class="controls">	
	<input 
		type="text"
...
<div class="control-group">
<label class="control-label"><?php echo JText::_('MOD_AGOSMSSEARCHAGOSMS_ADDRESS'); ?></label>	
<div class="controls">	
...
<button 
		...
		type="button">
<?php echo JText::_('MOD_AGOSMSSEARCHAGOSMS_CALCULATE_CORDS'); ?>
	</button>
</div>
<hr>