...
<div class="gsearch-field-select cusotm2">	
	<h3>
		<?php echo JText::_('MOD_AGOSMSSEARCHAGOSMSFILTER_TYPE_CUSTOM2_SELECT'); ?>
	</h3>
	<select class="inputbox" name="cusotm2" style="display: none;">
		<option value=""><?php echo JText::_('MOD_AGOSMSSEARCHAGOSMSFILTER_TYPE_CUSTOM2_SELECT'); ?></option>
