...
class JFormFieldFilters extends JFormField 
{
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
			...
			$mitems[] = JHTML::_('select.option', 'date', JText::_('MOD_AGOSMSSEARCHAGOSMSFILTER_TYPE_DATE'));
		...
		if (count($fields)) {
			...
			$output .= "
				<script>
					var MOD_AGOSMSSEARCHAGOSMSFILTER_SELECT_FIELD_TYPE = '" . JText::_("MOD_AGOSMSSEARCHAGOSMSFILTER_SELECT_FIELD_TYPE") . "';
					var MOD_AGOSMSSEARCHAGOSMSFILTER_TYPE_TEXT_FIELD = \"" . JText::_("MOD_AGOSMSSEARCHAGOSMSFIELD") . "\";
				</script>
			";
