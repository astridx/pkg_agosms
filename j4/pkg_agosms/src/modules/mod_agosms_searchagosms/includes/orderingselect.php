...
class JFormFieldOrderingSelect extends JFormField
{
	...
	{
			$mitems[] = JHTML::_('select.option', 'title', JText::_('MOD_AGOSMSSEARCHAGOSMSSORTING_TITLE'));
			$mitems[] = JHTML::_('select.option', 'alias', JText::_('MOD_AGOSMSSEARCHAGOSMSSORTING_ALIAS'));
			$mitems[] = JHTML::_('select.option', 'created', JText::_('MOD_AGOSMSSEARCHAGOSMSSORTING_DATE'));
			$mitems[] = JHTML::_('select.option', 'publish_up', JText::_('MOD_AGOSMSSEARCHAGOSMSSORTING_DATE_PUBLISHING'));
			$mitems[] = JHTML::_('select.option', 'category', JText::_('MOD_AGOSMSSEARCHAGOSMSSORTING_CATEGORY'));
			$mitems[] = JHTML::_('select.option', 'hits', JText::_('MOD_AGOSMSSEARCHAGOSMSSORTING_POPULAR'));
			$mitems[] = JHTML::_('select.option', 'featured', JText::_('MOD_AGOSMSSEARCHAGOSMSSORTING_FEATURED'));
			$mitems[] = JHTML::_('select.option', 'rand', JText::_('MOD_AGOSMSSEARCHAGOSMSSORTING_RANDOM'));
			...
			$query = "SELECT f.*, g.title as group_name FROM #__fields as f 
						...
						WHERE f.context = 'com_agosms.agosm'
