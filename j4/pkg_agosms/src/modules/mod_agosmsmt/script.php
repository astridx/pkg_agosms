 ...
 * @since  1.0.40
 */
class Mod_AgosmsmtInstallerScript
{
	/**
	...
	{
		echo '<p>' . JText::_('MOD_AGOSMSMT_UNINSTALL') . '</p>';
	}
	...
	{
		echo '<p>' . JText::_('MOD_AGOSMSMT_UPDATE') . '</p>';
	}
	...
	{
		echo '<p>' . JText::_('MOD_AGOSMSMT_PREFLIGHT') . '</p>';
	}
	...
	{
		echo '<p>' . JText::_('MOD_AGOSMSMT_POSTFLIGHT') . '</p>';
	}
}
