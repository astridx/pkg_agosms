...
namespace AgosmNamespace\Component\Agosms\Administrator\Helper;
...
use AgosmNamespace\Component\Agosms\Site\Helper\AssociationHelper;
...
class AssociationsHelper extends AssociationExtensionHelper
{
	...
	public function getItem($typeName, $id)
	{
		...
		switch ($typeName) {
			case 'agosm':
				$table = Table::getInstance('AgosmTable', 'AgosmNamespace\\Component\\Agosms\\Administrator\\Table\\');
				break;
