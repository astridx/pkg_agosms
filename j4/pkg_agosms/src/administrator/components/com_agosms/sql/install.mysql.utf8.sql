CREATE TABLE IF NOT EXISTS `#__agosms_details` (
  ...
  `showdefaultpin` tinyint NOT NULL DEFAULT 0,
  ...
  `showpopup` tinyint NOT NULL DEFAULT 0,
...
ALTER TABLE `#__agosms_details` ADD COLUMN  `access` int unsigned NOT NULL DEFAULT 0 AFTER `alias`;

ALTER TABLE `#__agosms_details` ADD KEY `idx_access` (`access`);

ALTER TABLE `#__agosms_details` ADD COLUMN  `catid` int NOT NULL DEFAULT 0 AFTER `alias`;

ALTER TABLE `#__agosms_details` ADD COLUMN  `state` tinyint NOT NULL DEFAULT 0 AFTER `alias`;

ALTER TABLE `#__agosms_details` ADD KEY `idx_catid` (`catid`);

ALTER TABLE `#__agosms_details` ADD COLUMN  `published` tinyint NOT NULL DEFAULT 0 AFTER `alias`;
...
ALTER TABLE `#__agosms_details` ADD COLUMN  `ordering` int NOT NULL DEFAULT 0 AFTER `alias`;

ALTER TABLE `#__agosms_details` ADD COLUMN  `params` text NOT NULL AFTER `alias`;

ALTER TABLE `#__agosms_details` ADD COLUMN `checked_out` int unsigned NOT NULL DEFAULT 0 AFTER `alias`;
...
ALTER TABLE `#__agosms_details` ADD COLUMN  `featured` tinyint unsigned NOT NULL DEFAULT 0 COMMENT 'Set if agosm is featured.';
...
ALTER TABLE `#__agosms_details` ADD COLUMN `text` varchar(255) NOT NULL DEFAULT '{shariff theme=color}';