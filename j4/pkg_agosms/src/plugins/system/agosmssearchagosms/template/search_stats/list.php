...
$override = JPATH_SITE . "/templates/{$mainframe->getTemplate()}/html/com_agosms/search_stats/list.php";
$file_path = __FILE__;
...
//get model
require_once(JPATH_SITE . "/plugins/system/agosmssearch/models/com_agosms/model.php");
	...
	<div class="btn-toolbar" role="toolbar" aria-label="Toolbar" id="toolbar" style="float: right;">	
		<div class="btn-wrapper" id="toolbar-refresh">
			...
			<div class="ajax-result" style="display: none;">
				<img style="width: 20px;" src="<?php echo JURI::root(); ?>modules/mod_agosms_searchagosms/assets/images/loading.png" />
			</div>
		</div>
	</div>	
